...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center max-h-screen h-[89vh] justify-center bg-[#F5F7FA]  md:p-8">
      <div className="mx-auto max-w-md text-center">
        ...
        <div className="flex flex-col justify-center sm:flex-row sm:space-x-3 sm:space-y-0">
